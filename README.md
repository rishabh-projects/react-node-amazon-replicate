...
Building an e-commerce website using MERN stack (MongoDB, ExpressJS, React and Node.JS).
...
```
$ git clone https://github.com/rishabh-projects/react-node-amazon-replicate
$ cd amazona
```
...
5. Create React App
   ...
   4. copy index.html body content to App.js
   5. copy style.css content to index.css
   6. replace class with className
   7. we have static product data in App.js
   8. create data object consisting products
   9. create images folder
   10. get product data dynamically
   11. copy fon-awesome styles in frontend index.html
...
7. Create Rating and Product Component
   1. create components/Rating.js and components/Product.js
   2. create div.rating
   3. style div.rating, span and last span
   4. Create Product component
   5. Use Rating component
   6. Pass numReviews and Ratings as Props to Rating.js
8. Build Product Screen
   1. Install react-router-dom in frontend
...
9. Create Node.JS Server
   ...
   3. Add .js to imports. And copy data.js also
   4. npm install express
   5. create server.js
   6. npm install --save-dev nodemon
   7. add start command as node backend/server.js
   8. modify start script in package.json
   9. require express
   10. create route for / return backend is ready.
   11. move products.js from frontend to backend
   12. create route for /api/products
   13. return products
   14. run npm start
10. Load Products From Backend
    1. setup proxy in package.json of frontend. npm install axios. 
    2. And edit HomeScreen.js
